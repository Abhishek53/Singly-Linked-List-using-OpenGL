...
void title()
{
	...
	drawstring(200.0, 450.0, "COMPUTER GRAPHICS PROJECT", 3);
	drawstring(50.0, 350.0, "NAME : ABHISHEK R", 1);
	drawstring(50.0, 250.0, "GUIDED BY: DR VIMUKTHA EVANGELEEN SALIS", 1);
	drawstring(50.0, 300.0, "UNIVERSITY NUMBER: 1BG16CS004", 1);
	drawstring(50.0, 200.0, "SEM: VI", 1);
	drawstring(50.0, 150.0, "BATCH: CSE-A1", 1);
	drawstring(50.0, 100.0, "COLLEGE: BNMIT", 1);
	...
	while (temp != NULL)
	{
		for (k = 0; k<count; k++)
		{
			...
			if (temp->link == NULL)
			{
				...
				glEnd();
				glColor3f(0.93f, 0.5332f, 0.186f);
				glBegin(GL_POLYGON);
				glVertex2i(x2 + k * 130, y1);
				glVertex2i(x2 + k * 130, y3);
